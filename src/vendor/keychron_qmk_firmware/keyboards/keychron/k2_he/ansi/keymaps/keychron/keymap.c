...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_84(
        ...
        KC_GRV,   MT(MOD_LCTL, KC_1),  MT(MOD_LSFT, KC_2),  MT(MOD_LALT, KC_3),  MT(MOD_LGUI, KC_4),  LT(1, KC_5),  LT(1, KC_6),  MT(MOD_RGUI, KC_7),  MT(MOD_RALT, KC_8),  MT(MOD_RSFT, KC_9),  MT(MOD_RCTL, KC_0),  KC_MINS,  KC_EQL,   KC_BSPC,           KC_PGUP,
    ...
    [MAC_FN] = LAYOUT_ansi_84(
        ...
        _______,  UG_NEXT,  UG_VALU,  UG_HUEU,  UG_SATU,  UG_SPDU,  KC_INS,   KC_HOME,  KC_END,   KC_PGDN,  KC_PGUP,  _______,  _______,  _______,            BT_HST2,
        _______,  UG_PREV,  UG_VALD,  UG_HUED,  UG_SATD,  UG_SPDD,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_ENT,   _______,            _______,            BT_HST3,
    ...
    [WIN_BASE] = LAYOUT_ansi_84(
        ...
        KC_TAB,         KC_Q,                KC_W,                KC_E,                KC_R,                KC_T,         KC_Y,         KC_U,                KC_I,                KC_O,                KC_P,                   KC_LBRC,  KC_RBRC,  KC_BSLS,                  KC_PGDN,
        KC_ESC,         MT(MOD_LCTL, KC_A),  MT(MOD_LSFT, KC_S),  MT(MOD_LALT, KC_D),  MT(MOD_LGUI, KC_F),  LT(3, KC_G),  LT(3, KC_H),  MT(MOD_RGUI, KC_J),  MT(MOD_RALT, KC_K),  MT(MOD_RSFT, KC_L),  MT(MOD_RCTL, KC_SCLN),  KC_QUOT,            KC_ENT,                   KC_HOME,
