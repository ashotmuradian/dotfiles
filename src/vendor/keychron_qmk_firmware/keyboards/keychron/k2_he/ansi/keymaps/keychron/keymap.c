...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [FN0] = LAYOUT_ansi_84(
        ...
        KC_GRV,   LM(3, MOD_LCTL),     LM(3, MOD_LSFT),     LM(3, MOD_LALT),     LM(3, MOD_LGUI),     MO(5),        MO(6),        LM(4, MOD_RGUI),     LM(4, MOD_RALT),     LM(4, MOD_RSFT),     LM(4, MOD_RCTL),     KC_MINS,  KC_EQL,   KC_BSPC,           KC_PGUP,
    ...
    [FN1] = LAYOUT_ansi_84(
        ...
        _______,  _______,  _______,  _______,  MO(9),    _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_ENT,   _______,            _______,            BT_HST3,
    ...
    [FN3] = LAYOUT_ansi_84(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     _______,  _______,  _______,            _______,
    ...
    [FN5] = LAYOUT_ansi_84(
        KC_CAPS,  KC_BRID,  KC_BRIU,  KC_TASK,  KC_FILE,  UG_VALD,  UG_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_PAUS,  NK_TOGG,  UG_NEXT,
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     _______,  _______,  _______,            BT_HST1,
        _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,   KC_HOME,  KC_END,   KC_PGDN,  KC_PGUP,  KC_ESC,   _______,  _______,            BT_HST2,
    ...
    [FN9] = LAYOUT_ansi_84(
        ...
        _______,  _______,  MS_ACL1,  MS_ACL0,  _______,  _______,  MS_LEFT,  MS_DOWN,  MS_UP,    MS_RGHT,  MS_BTN1,  MS_BTN2,            _______,            _______,
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______)
};
